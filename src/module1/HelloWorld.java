...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		map2 = new UnfoldingMap(this, 450, 50, 325, 500, provider);
		map2.zoomAndPanTo(zoomLevel, new Location(45.2f, 18.0f));
	...
	public static void main (String... args) {
		...
		PApplet.runSketch(new String[]{"Hello World"}, hw);
	}
